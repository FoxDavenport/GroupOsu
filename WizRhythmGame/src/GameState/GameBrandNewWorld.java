...
public class GameBrandNewWorld extends GameState
                   implements Runnable {
	...
	public GameBrandNewWorld(GameStateManager gsm) {
		this.gsm = gsm;
	...
	public void init() {
		...
		bg = new InterfaceBackground("/image/EniesLobby.png");
		
		setBeat();
		
		gameMusic = new Music("Brand New World.mp3", false);
		gameMusic.start();
