...
public class GameMariya extends GameState
	...
	public void setBeat() {
		...
		beats = new Beat[] {
				...
				new Beat(startTime + gap * 1667, "L"),
				new Beat(startTime + gap * 1669, "D"),
				new Beat(startTime + gap * 1671, "F"),
				new Beat(startTime + gap * 1672, "F"),
				new Beat(startTime + gap * 1673, "F"), 
				new Beat(startTime + gap * 1674, "S"), 
				new Beat(startTime + gap * 1675, "D"),
				new Beat(startTime + gap * 1676, "F"),             
				new Beat(startTime + gap * 1678, "D"),
				new Beat(startTime + gap * 1680, "D"),
				new Beat(startTime + gap * 1681, "J"), 
				new Beat(startTime + gap * 1683, "S"), 
				new Beat(startTime + gap * 1685, "S"),
				new Beat(startTime + gap * 1687, "D"),              
				new Beat(startTime + gap * 1689, "J"),
				new Beat(startTime + gap * 1691, "K"),  
				new Beat(startTime + gap * 1693, "L"),
				new Beat(startTime + gap * 1695, "D"), 
				new Beat(startTime + gap * 1697, "K"),
				new Beat(startTime + gap * 1699, "L"), 
				new Beat(startTime + gap * 1701, "J"),
				new Beat(startTime + gap * 1703, "K"),  
				new Beat(startTime + gap * 1705, "L"),
				new Beat(startTime + gap * 1707, "S"),  
				new Beat(startTime + gap * 1709, "D"),
				new Beat(startTime + gap * 1711, "F"), 
				new Beat(startTime + gap * 1713, "S"), 
				new Beat(startTime + gap * 1715, "D"),
				new Beat(startTime + gap * 1717, "D"),
				new Beat(startTime + gap * 1719, "D"),
				new Beat(startTime + gap * 1721, "D"),
				new Beat(startTime + gap * 1722, "S"),
				new Beat(startTime + gap * 1723, "F"),              
				new Beat(startTime + gap * 1724, "J"),
				new Beat(startTime + gap * 1726, "K"),  
				new Beat(startTime + gap * 1728, "L"),
				new Beat(startTime + gap * 1730, "S"),  
				new Beat(startTime + gap * 1732, "D"),
				new Beat(startTime + gap * 1733, "F"), 
				new Beat(startTime + gap * 1734, "S"), 
				new Beat(startTime + gap * 1735, "D"),
				new Beat(startTime + gap * 1737, "D"),
				new Beat(startTime + gap * 1739, "D"),
				new Beat(startTime + gap * 1741, "D"),
				new Beat(startTime + gap * 1745, "S"),
