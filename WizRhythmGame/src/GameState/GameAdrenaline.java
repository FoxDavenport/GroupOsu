...
public class GameAdrenaline extends GameState
                   implements Runnable {
	...
	//runs when GameAdrenaline state is called
	public GameAdrenaline(GameStateManager gsm) {
		this.gsm = gsm;
	...
	public void run() {
		...
		if (!exit) {
			...
			CompareScore c = new CompareScore("Adrenaline", score, CollectName.userName);
			MenuState.RetrieveLeaderboard("Adrenaline");
		}
